...
def preprocess_user_input(user_input):
    input_token = nltk.word_tokenize(user_input)
    generating_stem = get_stem_words(input_token, ignore_words)
    stem_word=sorted(list(set(generating_stem)))
...
def bot_response(user_input):
   ...
   predicted_class = "PRO-C120-Project-Boilerplate-main/chatbot_model.h5"
